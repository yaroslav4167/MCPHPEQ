...
function BonusMoneyAmount()
{ //Бонус-валюта пользователя
...
function getBonuces($id)
{//Сдача квеста/получение бонусов
    if (!userRule()) {
        return;
    }
